...
const char* ssid        = "MEO-F65F0D";
const char* password    = "935J044R2RT";
//const char* ssid        = "Chaishop_AP";
//const char* password    = "chaishop2017";
const char* serverName  = "http://weather.macheira.eu/esp-post-data.php";
String apiKeyValue      = "Vy3Aw77ClNjdx06e1D8eLnceGPd9AbPU";
String sensorId         = "1";
